			...
			_export('PictureItCtrl', PictureItCtrl = function (_MetricsPanelCtrl) {
				...
				_createClass(PictureItCtrl, [{
					...
					value: function addSensor() {
						if (this.panel.sensors.length == 0) this.panel.sensors.push({ name: 'A-series', xlocation: 200, ylocation: 200, width: 100, height: 100, format: '%.2f', bgcolor: 'rgba(0, 0, 0, 0.58)', color: '#FFFFFF', size: 22, bordercolor: 'rgb(251, 4, 4)', visible: true });else {
